...
public GameObject target;
    ...
    {
        if (other.gameObject.tag == "Turrets" || other.gameObject.tag == "Bullet"|| other.gameObject.tag == "" || other.gameObject.tag == "TileMapBase"|| other.gameObject.tag == "StorageNode") 
        {
        
        }
        else if(this.gameObject.CompareTag("Enemies") && other.CompareTag("Enemies"))
        {
