...
namespace PlayerScripts
{
    ...
    public class Shooting : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            rateOfFire = weaponManager.currWeapon.weaponProperties.fireRate;
        }
        ...
        public void Shoot()
        {
            ...
            bullet.GetComponent<Bullet>().damage = weaponManager.currWeapon.weaponProperties.damage;
        ...
        public void Aim()
        {
            if (isAiming == true)
            {
                maxOffset = Mathf.Lerp(maxOffset, 1f, 0.5f);
            }
            else
            {
                maxOffset = Mathf.Lerp(maxOffset, 10f, 0.5f);
            }
        }
    }
}
